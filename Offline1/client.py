...
a = BitVector(size=0)
msg = s.recv(1024)
AES_output += BitVector(hexstring=msg.decode("utf-8"))
...
round_keys.append(BitVector(textstring="Thats my Kung Fu"))
...
decipher_output += decrypt(BitVector(hexstring=AES_output.get_bitvector_in_hex()[0:32]))
